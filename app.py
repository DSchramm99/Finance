...
if page == "Signals":
    ...
    if st.sidebar.button("🚀 Generate Top 5 Signals"):
        ...
        # This significantly speeds up the analysis of large indices like S&P 500
        # We use a mapping to maintain the original order of tickers
        results_map = {}
    ...
    if "results" in st.session_state:
        ...
        # Use centralized and cached company name retrieval
